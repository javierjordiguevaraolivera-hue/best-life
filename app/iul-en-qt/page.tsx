...
const trustBadges = [
  { icon: "/best-money-assets/tax-free.svg", text: "Tax-free access" },
  { icon: "/best-money-assets/family-protection.svg", text: "Protect your family" },
  { icon: "/best-money-assets/minutes.svg", text: "Takes under 2 min" },
];

const redirectTargetUrl = "https://life.quotify.us/";

const introBenefits = [
  {
    icon: "📈",
    title: "Compound Interest Growth",
    description: "Grow your money with potential returns up to 9.5%.",
  },
  {
    icon: "🚫",
    title: "Tax-Free Withdrawals",
    description: "Access funds with tax advantages.",
  },
  {
    icon: "🏦",
    title: "Instant Liquidity",
    description: "Access cash through policy loans anytime.",
  },
  {
    icon: "🛡️",
    title: "Downside Protection",
    description: "Protected from losses with a 0% floor.",
  },
  {
    icon: "🏥",
    title: "Living Benefits",
    description: "Access funds during illness or emergencies.",
  },
];

const howItWorksSteps = [
  { number: "1", title: "We ask a few questions", description: "to see if you qualify." },
  { number: "2", title: "We review your profile", description: "and estimate your IUL benefit." },
  { number: "3", title: "See your plan", description: "and receive your benefit." },
];

const metrics = [
  { value: "73,698", label: "Families served in 2026" },
  { value: "100%", label: "Family protection secured" },
  { value: "$200K+", label: "Potential cash value" },
];
...
const thankYouHighlights = [
  {
    title: "Penalty-Free Access",
    description: "Use your money anytime, with no limits",
  },
  {
    title: "Wealth Strategy",
    description: "The financial secret most people never hear about",
  },
];

const thankYouCallSteps = [
  {
    title: "The number may look unknown",
    description:
      "We work with advisors nationwide. The area code may vary. Answer it.",
    icon: "bolt",
  },
  {
    title: "They will give a full name",
    description:
      "Your advisor will confirm your request. It is 100% professional and free.",
    icon: "user",
  },
  {
    title: "Find a quiet spot",
    description:
      "The call is quick, just 10 to 15 minutes for your exact rate.",
    icon: "focus",
  },
];
...
const thankYouInfoList = [
  {
    title: "Personal Info",
    description: "Birth date, marital status, occupation",
  },
  {
    title: "Health Overview",
    description: "Height, weight, meds, basic history",
  },
  {
    title: "Income & Goals",
    description: "Yearly income, 10-20 year goals",
  },
  {
    title: "Needed Coverage",
    description: "How much does your family need? (10-15x income)",
  },
  {
    title: "Beneficiaries",
...
const thankYouFaqs = [
  {
    ...
    description:
      "We will try again 2-3 times at different times of day.",
  },
  {
    title: "Is there any cost?",
    description:
      "No. The consult is 100% free with no purchase required.",
  },
  {
    title: "Do I need lots of money?",
    description:
...
function getPhoneValidationMessage(value: string) {
  ...
  if (digits.length !== 10) {
    return "Enter a valid U.S. number with 10 digits.";
  }

  if (!/^[2-9]\d{2}[2-9]\d{6}$/.test(digits)) {
    return "Enter a real U.S. number.";
  }
  ...
  if (
    ...
    return "Enter a real U.S. number. Avoid sequences or sample numbers.";
  }
      ...
      <div className="mx-auto w-full max-w-[490px] overflow-hidden bg-white">
        <section className="border-t border-[#f2d7d7] px-4 pb-6 pt-5 text-center md:px-6">
          ...
          <p className="mt-4 text-[14px] leading-[1.45] text-[#5e6781]">
            A licensed advisor will call within the next{" "}
        ...
        <section className="border-t-[3px] border-[#20d47a] bg-[#ef3131] px-4 py-4 text-center md:px-6">
          <div className="flex items-center justify-center gap-2 text-[16px] font-black tracking-[-0.03em] text-[#151515]">
            ...
            <span>Get Ready - Call Incoming</span>
          </div>
          ...
          <p className="mt-4 text-[14px] leading-[1.45] text-[#141414]">
            Keep your phone close with{" "}
            <span className="font-black">sound on.</span>
            <br />
            The call is quick -{" "}
            <span className="font-black">10 to 15 minutes</span> for your exact rate.
          </p>
        </section>
        ...
        <section className="border-t-[3px] border-[#ffbe2e] bg-[#fff1b8] px-4 py-4 md:px-6">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <h3 className="text-[17px] font-black tracking-[-0.03em] text-[#7b4a10]">
              See This While You Wait
            </h3>
          </div>
          <p className="mt-3 text-[14px] leading-[1.4] text-[#7b4a10]">
              Learn how to protect your family WHILE building tax-free wealth
          </p>
        ...
        <section className="border-t-[3px] border-[#ffbe2e] bg-[#1e2639] px-5 py-8 text-center text-white md:px-6">
          ...
          <h3 className="mt-4 text-[17px] leading-[1.4] font-semibold tracking-[-0.03em]">
            Keep your phone close and{" "}
            <span className="font-black text-[#ffbe2e]">sound on.</span>
          </h3>
          <p className="mt-3 text-[14px] leading-[1.5] text-white/80 italic">
            If you see a call in the next{" "}
          ...
          <p className="mx-auto mt-6 max-w-[380px] text-[14px] leading-[1.6] text-white/55">
            Best Life is an independent insurance lead platform. We are not an
            insurer. The advisors who contact you are licensed and regulated by
        ...
        <div className="mx-auto flex w-full max-w-[760px] flex-col items-center">
          ...
          <div className={`mt-7 text-center md:mt-9 ${animationClass}`}>
            <h2 className="mx-auto max-w-[720px] text-[30px] leading-[1.16] font-bold tracking-[-0.05em] text-[#101820] md:text-[46px]">
              {currentStep === "age" && "Which age group are you in?"}
              {currentStep === "goal" &&
                "What would you like from life insurance?"}
              {currentStep === "state" && "Select your state:"}
              {currentStep === "name" && "What is your full name?"}
              {currentStep === "phone" &&
                "What number should we send your quote to?"}
              {currentStep === "email" &&
                "What email should we send your quote to?"}
            </h2>
          </div>
