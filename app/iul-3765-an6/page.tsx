...
const redirectTargetUrl = "https://ntdr.quotify.us/?oid=3765&affid=3814";
...
const introBenefits = [
  ...
  {
    icon: "🚫",
    title: "Retira hasta $650,000 tax free",
        ...
        <div className="w-full max-w-[800px] px-[10px] py-[10px]">
          <div className="text-center">
            <h1 className="mx-auto max-w-[330px] text-[31px] leading-[1.34] font-bold text-[#0d2b5b] md:max-w-none md:text-[52px] md:leading-[1.14]">
              Aplica Hoy a los Beneficios IUL 2026
            </h1>
          ...
          <div className="mt-[15px] grid gap-[15px]">
            {introBenefits.map((benefit) => (
              ...
              >
                <div className="w-[5px] shrink-0 bg-[#1a73e8]" />
                <div className="flex flex-1 items-center gap-[12px] px-[16px] py-[13px]">
                  <div className="flex min-w-[38px] justify-center text-[26px] leading-none">
