...
const ageOptions = ["25 to 34", "35 to 44", "45 to 54", "55 to 65", "65+"];
const goalOptions = ["Life insurance", "Save and invest", "Retirement planning", "I'm not sure yet"];
...
const progressMap: Partial<Record<Step, { filled: number; total: number; label: string }>> = {
  goal: { filled: 2, total: 6, label: "Progress: 32%" },
  location: { filled: 3, total: 6, label: "Progress: 52%" },
  name: { filled: 4, total: 6, label: "Progress: 67%" },
  phone: { filled: 5, total: 6, label: "Progress: 88%" },
  email: { filled: 19, total: 20, label: "Progress: 97%" },
};

const steps: Step[] = ["age", "goal", "location", "name", "phone", "email", "success"];
const storageKey = "quotify-us-en-funnel-v1";
const deviceStorageKey = "best-money-device-id";
const formId = "quotify-us-en-form";
const formName = "quotify_us_en_life_insurance_form";
  ...
  return (
    <footer className="px-4 pb-12 pt-8 text-center text-[#5d6471]">
      ...
      <div className="mt-6 space-y-4 text-[11px] leading-[1.6]">
        ...
        <p>Quotify is an independent lead generation and marketing service provider. This website and the services offered are not sponsored, affiliated with, endorsed, or administered by Facebook. The content on this site has not been reviewed, approved, or certified by Facebook or any of its subsidiaries.</p>
      </div>
    </footer>
  );
}
    ...
    <div className="overflow-hidden rounded-[26px] bg-white shadow-[0_20px_50px_rgba(15,23,42,0.12)]">
      <section className="border-b-[3px] border-[#10b981] px-5 pb-[18px] pt-5 text-center">
        ...
        <h1 className="mt-4 text-[1.4em] font-bold leading-[1.3] text-[#1f2937]">
          Congratulations! Your request was <span className="text-[#10b981]">successfully received</span>
        </h1>
        <p className="mt-3 text-[0.92em] leading-[1.5] text-[#6b7280]">
          You are one step closer to the financial strategy used by high-net-worth families.
        </p>
      </section>
      ...
      <section className="relative bg-[linear-gradient(135deg,#ef4444,#dc2626)] px-5 pb-[22px] pt-6 text-center text-white">
        ...
        <h2 className="text-[1.35em] font-bold">📞 We'll Call You Soon</h2>
        ...
        <p className="mt-3 text-[0.96em] leading-[1.6]">
          A licensed advisor will contact you for your personalized 30-45 minute consultation.
        </p>
      </section>
      ...
      <section className="border-y-4 border-[#f59e0b] bg-[#fef3c7] px-5 pb-[18px] pt-5">
        <div className="inline-block rounded-full bg-[linear-gradient(135deg,#ef4444,#dc2626)] px-4 py-2 text-[0.85em] font-bold text-white animate-[pulseLite_2s_ease-in-out_infinite]">
          ⚡ Watch This Now - 3 Minutes
        </div>
        <h3 className="mt-3 text-[1.15em] font-bold leading-[1.3] text-[#78350f]">
          Learn While You Wait for the Call
        </h3>
        <p className="mt-2 text-[0.86em] leading-[1.4] text-[#92400e]">
          Discover how to protect your family while building tax-advantaged wealth.
        </p>
        ...
        <div className="mt-4 grid gap-3">
          <div className="rounded-[8px] border-l-[3px] border-[#10b981] bg-white px-3 py-3">
            <strong className="block text-[0.95em] text-[#1f2937]">✓ No-Penalty Access</strong>
            <span className="text-[0.9em] text-[#6b7280]">Use your money when you need it</span>
          </div>
          <div className="rounded-[8px] border-l-[3px] border-[#10b981] bg-white px-3 py-3">
            <strong className="block text-[0.95em] text-[#1f2937]">✓ Wealth-Building Strategy</strong>
            <span className="text-[0.9em] text-[#6b7280]">A strategy most families never hear about</span>
          </div>
        </div>
      </section>

      <section className="bg-white px-5 py-5">
        <h3 className="text-[1.1em] font-bold text-[#1f2937]">📋 What to Expect on the Call</h3>
        <div className="mt-4 grid gap-3">
          <div className="rounded-[10px] border-l-[3px] border-[#3b82f6] bg-[#f9fafb] px-3 py-3">
            <strong className="block text-[0.9em] text-[#1f2937]">⚡ The Number May Vary</strong>
            <p className="mt-1 text-[0.82em] leading-[1.5] text-[#6b7280]">
              We work with licensed advisors nationwide. The area code may vary depending on the specialist assigned to you.
            </p>
          </div>
          <div className="rounded-[10px] border-l-[3px] border-[#3b82f6] bg-[#f9fafb] px-3 py-3">
            <strong className="block text-[0.9em] text-[#1f2937]">⚡ Full Identification</strong>
            <p className="mt-1 text-[0.82em] leading-[1.5] text-[#6b7280]">
              Your advisor will introduce themselves by full name and confirm the request you just submitted.
            </p>
          </div>
          <div className="rounded-[10px] border-l-[3px] border-[#3b82f6] bg-[#f9fafb] px-3 py-3">
            <strong className="block text-[0.9em] text-[#1f2937]">⚡ Quiet Setting</strong>
            <p className="mt-1 text-[0.82em] leading-[1.5] text-[#6b7280]">Find a private place. The consultation takes 30-45 minutes.</p>
          </div>
        </div>
      </section>

      <section className="border-t-[3px] border-[#3b82f6] bg-[#f0f9ff] px-5 py-5">
        <h3 className="text-[1.1em] font-bold text-[#1e40af]">✅ Have This Information Ready</h3>
        <ul className="mt-4 grid gap-3">
          {[
            ["Personal Details", "Date of birth, marital status, occupation"],
            ["General Health", "Height, weight, medications, basic health history"],
            ["Income & Goals", "Annual income and 10-20 year goals"],
            ["Desired Protection", "How much your family may need (10-15x your income)"],
            ["Beneficiaries", "Names of the people you want to protect"],
          ].map(([title, text]) => (
      ...
      <section className="border-t-2 border-[#e5e7eb] bg-white px-5 py-4 text-center">
        <h4 className="text-[0.95em] font-bold text-[#1f2937]">🔒 Your Information Is Protected</h4>
      ...
      <section className="bg-[#f9fafb] px-5 py-5">
        <h3 className="text-[1.1em] font-bold text-[#1f2937]">❓ Quick Questions</h3>
        <div className="mt-4 grid gap-3">
          {[
            ["What if I miss the call?", "We'll try 2-3 times at different times."],
            ["Is there any cost?", "No. The consultation is 100% free with no obligation."],
            ["Do I need a lot of money?", "No. We work with budgets from $100 to $5,000+ per month."],
          ].map(([title, text]) => (
      ...
      <section className="relative border-t-4 border-[#fbbf24] bg-[linear-gradient(135deg,#1e293b,#0f172a)] px-5 pb-7 pt-10 text-center text-white">
        ...
        <p className="text-[1.05em] leading-[1.7] text-[#e5e7eb]">
          Keep your phone nearby with the <strong className="inline-block rounded-[6px] bg-[rgba(251,191,36,0.1)] px-3 py-1 text-[1.15em] uppercase tracking-[0.5px] text-[#fbbf24]">ringer on</strong>
        </p>
        <p className="mt-3 text-[0.9em] italic text-white/85">
          If you see an incoming call within the next 2 hours, it is probably us.
        </p>
      </section>
    </div>
  );
...
export default function QuotifyUsEnPageClient() {
  ...
  const page = pathname || "/quotify-us-en";
  const progress = progressMap[step];
  const displayName = answers.firstName.trim() || "there";
  ...
  async function submit() {
    ...
    try {
      ...
      const response = await fetch("/api/lead-quotify-us-en", {
        method: "POST",
        headers: {
      ...
      setSubmitError(error instanceof Error ? error.message : "We could not submit your request.");
    } finally {
        ...
        {step === "success" ? (
          ...
          <section className="min-h-[100dvh] bg-white px-[3px] py-5">
              ...
              <>
                <div className="rounded-[16px] border-b-[3px] border-[#ffd700] bg-[#fff8dc] px-4 py-4 text-center">
                  <div className="mx-auto max-w-[370px] font-['Poppins',sans-serif] text-[1.6rem] font-bold leading-[1.05] tracking-[-0.038em] text-[#111]">
                    ⚠️ ATTENTION: New Life Insurance Program - Available{detectedCity ? ` in ${detectedCity}!` : "!"}
                  </div>
                </div>
                <div className="px-[10px]">
                  <div className="mt-8 text-center">
                    <h3 className="mx-auto max-w-[404px] font-['Poppins',sans-serif] text-[1.22rem] font-bold leading-[1.18] tracking-[-0.024em] text-[#111827]">
                      Find out in less than 60 seconds if you qualify for this exclusive benefit
                    </h3>
                  </div>
            ...
            {step === "goal" && (
              <>
                <div className="mt-5 text-center">
                  <h2 className="font-['Poppins',sans-serif] text-[2.08rem] font-bold leading-[1.05] tracking-[-0.045em] text-[#111827]">Your family deserves protection.</h2>
                  <h3 className="mx-auto mt-2 max-w-[398px] text-[1.24rem] leading-[1.25] tracking-[-0.02em] text-[#4b5568]">Choose a life insurance plan based on your goals.</h3>
                </div>
                <div className="mt-5 border-t border-[#e5e7eb]" />
                <div className="mt-5 text-center">
                  <h2 className="font-['Poppins',sans-serif] text-[2.18rem] font-bold leading-[1.03] tracking-[-0.048em] text-[#111827]">Tell me, what would you like life insurance to help you do?</h2>
                </div>
              ...
              <>
                <div className="px-[6px]">
                  <div className="mt-1 text-center">
                    <h2 className="relative left-1/2 w-[calc(100vw-6px)] max-w-none -translate-x-1/2 font-['Poppins',sans-serif] text-[1.46rem] font-extrabold leading-none tracking-[-0.066em] text-[#111827] whitespace-nowrap">PROTECT WHAT MATTERS MOST.</h2>
                    <h2 className="mx-auto mt-4 max-w-[318px] font-['Poppins',sans-serif] text-[1.58rem] font-bold leading-[1.18] tracking-[-0.032em] text-[#111827]">Get a quote in under 60 seconds.</h2>
                  </div>
                  {progress && (
                    <div className="mt-5">
                      <Progress {...progress} />
                  ...
                  <div className="mt-5 text-center">
                    <h2 className="font-['Poppins',sans-serif] text-[1.62rem] font-bold leading-[1.12] tracking-[-0.03em] text-[#111827]">Select your state:</h2>
                  </div>
                  <div className={`mt-4 rounded-[14px] border-[2px] px-4 py-[18px] text-center ${locationStatus === "loading" ? "border-[#2196f3] bg-[#e3f2fd]" : answers.locationText ? "border-[#2991f4] bg-[#d8ebff]" : "border-[#f5d68f] bg-[#fff7e1]"}`}>
                    {locationStatus === "loading" ? (
                      <>
                        <div className="text-[16px] text-[#1976d2]">🔍 Detecting your location...</div>
                        <div className="mt-2 text-[12px] text-[#666]">This only takes a few seconds</div>
                      </>
                      ...
                      <>
                        ...
                        <div className="mt-[7px]">
                          <span className="inline-flex rounded-full bg-[#41b349] px-[9px] py-[3px] text-[9.5px] font-bold leading-none text-white">Detected</span>
                        </div>
                      </>
                    ) : (
                      <>
                        <div className="text-[15px] font-semibold text-[#9b6b00]">We could not detect your state</div>
                        <div className="mt-2 text-[13px] text-[#765628]">Select your state manually to continue.</div>
                      </>
                    )}
                  </div>
                  <div className="mt-8">
            ...
            {step === "name" && (
              <>
                <div className="px-[4px]">
                  <div className="mt-1 text-center">
                    <h2 className="relative left-1/2 w-[calc(100vw-8px)] max-w-none -translate-x-1/2 font-['Poppins',sans-serif] text-[1.9rem] font-[500] leading-none tracking-[-0.09em] text-[#111827] whitespace-nowrap">PROTECT WHAT YOU LOVE MOST.</h2>
                  </div>
                  {progress && (
                    <div className="mt-5">
                      <Progress {...progress} />
                  ...
                  <div className="mx-[2px] mt-5 border-t border-[#e5e7eb]" />
                  <div className="mt-5 text-center">
                    <h2 className="font-['Poppins',sans-serif] text-[1.26rem] font-bold leading-[1.08] tracking-[-0.04em] text-[#111827] whitespace-nowrap">What is your full name?</h2>
                  </div>
                  <div className="mt-4 grid grid-cols-2 gap-[10px]">
                    <input value={answers.firstName} onChange={(e) => setAnswers((prev) => ({ ...prev, firstName: e.target.value }))} placeholder="First name" className="h-[72px] w-full rounded-[6px] border border-[#E9EAEC] bg-[#E9EAEC] px-[16px] pt-[14px] text-[18px] text-[#111827] outline-none transition placeholder:text-[#bfc4cb] focus:border-[#2f47ff] focus:bg-white" />
                    <input value={answers.lastName} onChange={(e) => setAnswers((prev) => ({ ...prev, lastName: e.target.value }))} placeholder="Last name" className="h-[72px] w-full rounded-[6px] border border-[#E9EAEC] bg-[#E9EAEC] px-[16px] pt-[14px] text-[18px] text-[#111827] outline-none transition placeholder:text-[#bfc4cb] focus:border-[#2f47ff] focus:bg-white" />
                  </div>
                  <button type="button" onClick={() => { if (!answers.firstName.trim() || !answers.lastName.trim()) return; setStep("phone"); }} className="mt-5 inline-flex h-[56px] w-full items-center justify-center gap-[12px] rounded-[8px] bg-[#3a9be7] px-6 text-[19px] font-bold text-white transition hover:bg-[#3493dd]">
                    <span className="font-extrabold tracking-[-0.02em]">Continue</span>
                  ...
                  <div className="mt-9 space-y-4 text-center text-[17px] leading-[1.45] text-[#111827]">
                    <p>🔒 Your information is encrypted and will never be shared with third parties.</p>
                    <p>⚠️ An advisor is available for a limited time. Reserve your spot now.</p>
                  </div>
                  <InlineTrustLogos />
                </div>
              </>
              ...
              <>
                <div className="px-[6px]">
                  <div className="mt-4 text-center">
                    <h3 className="text-[1.32rem] font-bold leading-[1.18] tracking-[-0.03em] text-[#111827]">🔒 Your quote is almost ready.</h3>
                    <h3 className="mt-1 text-[1.32rem] font-bold leading-[1.18] tracking-[-0.03em] text-[#111827]">📞 An available advisor can help you right now.</h3>
                  </div>
                  {progress && (
                    <div className="mt-4">
                      <Progress {...progress} />
                  ...
                  <div className="mx-[2px] mt-5 border-t border-[#e5e7eb]" />
                  <div className="mt-5 text-center">
                    <h2 className="mx-auto max-w-[392px] font-['Poppins',sans-serif] text-[1.72rem] font-bold leading-[1.16] tracking-[-0.04em] text-[#111827]">{displayName}, what number should we use to send your personalized quote?</h2>
                  </div>
                  ...
                  <button type="button" onClick={() => { const msg = phoneErrorMessage(answers.phoneNumber); if (msg) return setPhoneError(msg); setPhoneError(""); setStep("email"); }} className="mt-10 inline-flex h-[56px] w-full items-center justify-center gap-3 rounded-[8px] bg-[#3a9be7] px-6 text-[17px] font-bold text-white transition hover:bg-[#3493dd]">
                    <span className="font-extrabold tracking-[-0.02em]">See my quote now</span>
                    <svg viewBox="0 0 256 256" className="h-[18px] w-[18px]" fill="none">
                      <line x1="40" y1="128" x2="216" y2="128" stroke="currentColor" strokeWidth="24" strokeLinecap="round" strokeLinejoin="round" />
                      <polyline points="144 56 216 128 144 200" stroke="currentColor" strokeWidth="24" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
            ...
            {step === "email" && (
              <>
                <div className="px-[4px]">
                  <div className="mt-5 text-center">
                    <h2 className="font-['Poppins',sans-serif] text-[1.8rem] font-bold leading-[1.15] text-[#111827]">PROTECT WHAT YOU LOVE MOST.</h2>
                    <h4 className="mt-2 text-[1.05rem] leading-[1.45] text-[#374151]">You may be able to save up to 70% on life insurance.</h4>
                  </div>
                  {progress && (
                    <div className="mt-5">
                      <Progress {...progress} />
                  ...
                  <div className="mt-5 text-center">
                    <h2 className="font-['Poppins',sans-serif] text-[1.72rem] font-bold leading-[1.16] tracking-[-0.038em] text-[#111827]">
                      ...
                      {displayName}, what email should we use to send your quote?
                    </h2>
                  </div>
                  <div className="mt-6 rounded-[8px] border border-[#E9EAEC] bg-[#E9EAEC] transition focus-within:border-[#2f47ff] focus-within:bg-white">
                    <div className="flex items-center gap-3 px-3">
                      ...
                      <input value={answers.email} onChange={(e) => setAnswers((prev) => ({ ...prev, email: e.target.value }))} inputMode="email" autoComplete="email" placeholder="Ex: name@example.com" className="h-[56px] min-w-0 flex-1 bg-transparent text-[16px] text-[#111827] outline-none placeholder:text-[#c6c9cf]" />
                    </div>
                  </div>
                  <div className="mt-4 text-center text-[14px] leading-[1.55] text-[#4b5563]">🔐 Your information is secure. We only use it to send your quote.</div>
                  ...
                  {isSubmitting ? (
                    ...
                    <>
                      <span className="font-extrabold tracking-[-0.02em]">See my personalized quote</span>
                      <svg viewBox="0 0 256 256" className="h-[18px] w-[18px]" fill="none">
                  ...
                  <div className="mt-5 text-center text-[15px] font-semibold text-[#6b4eff]">⏳ Limited-time offer.</div>
                  <InlineTrustLogos />
                </div>
              </>
            )}
