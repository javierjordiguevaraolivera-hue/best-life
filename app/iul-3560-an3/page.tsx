...
const introBenefits = [
  ...
  },
  {
    ...
    description: "Retira tu dinero sin pagar impuestos al gobierno.",
  },
  {
    icon: "🏦",
    title: "Liquidez Inmediata",
    description: "Usa tu dinero en cualquier momento sin restricciones.",
  },
  {
    icon: "🛡️",
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    void sendPageViewVisitPayload(pageValue)
      ...
      .catch(() => {
        // If the payload cannot be sent, keep the default behavior: PageView only.
      });
        ...
        <div className="w-full max-w-[800px] px-[10px] py-[10px]">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-[340px] border-b-2 border-[#f1f5f9] pb-[15px] text-[13px] leading-[1.2] text-[#64748b] md:max-w-none md:text-[18px]">
              Disponible para personas de 22 a 50 años
            </p>
          </div>
