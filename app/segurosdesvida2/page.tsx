...
const redirectTargetUrl = "https://www.segurosdesvida.com/";
...
export default function Home() {
  ...
  const isRedirectPrelanding = pathname === "/segurosdesvida2";
  const showZipEntry = !isHomePage && !isRedirectPrelanding;
  ...
  }, [isRedirectPrelanding, storageKeyValue]);

  useEffect(() => {
    if (isRedirectPrelanding) return;
  ...
  }, [answers, currentStep, hasHydratedSavedData, isRedirectPrelanding, storageKeyValue]);
  ...
  }, [isHomePage, isRedirectPrelanding]);
  ...
  }, [answers.zipCode, defaultLocationText, hasLoadedGeo, isHomePage, isRedirectPrelanding]);
      ...
      <div className="mx-auto flex w-full max-w-[760px] flex-col items-center">
        ...
        <div
          className={`mx-auto flex w-full max-w-[392px] animate-[fade-up_0.7s_ease-out] flex-col items-center md:max-w-[352px] ${
            showZipEntry ? "mt-8 md:mt-6" : "mt-5 md:mt-4"
          }`}
        >
          {showZipEntry ? (
            <>
          ...
          <button
            ...
            className={`inline-flex h-[52px] w-full items-center justify-center rounded-full bg-[var(--brand)] px-6 text-[17px] font-extrabold tracking-[-0.02em] text-white transition hover:bg-[var(--brand-dark)] md:h-[47px] md:text-[19px] ${
              showZipEntry ? "mt-2 md:mt-3" : "mt-0 md:mt-1"
            }`}
          >
            <span
      ...
      {isSuccessPage ? (
        ...
        <>
          <div className="md:flex md:min-h-[calc(100vh-60px)] md:flex-col">
            ...
            <section className="border-t border-[#dfe9f4] bg-[#E5EDFB] px-4 py-5 md:mt-auto md:py-5">
