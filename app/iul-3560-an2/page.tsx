...
const introBenefits = [
  {
    icon: "📈",
    title: "Ahorro con Interés Compuesto (Hasta 9.3%)",
    description: "Haz crecer tu dinero para dejar un respaldo a tu familia.",
  },
  {
    icon: "🚫",
    title: "Retiros Libres de Impuestos",
    description: "Tus hijos pueden recibir el dinero sin cargas fiscales inesperadas.",
  },
  {
    icon: "🏦",
  ...
  },
  {
    ...
    description: "Usa tus fondos en caso de una enfermedad o emergencia grave.",
  },
];
        ...
        <div className="w-full max-w-[800px] px-[10px] py-[10px]">
          <div className="text-center">
            <h1 className="mx-auto max-w-[330px] text-[31px] leading-[1.34] font-extrabold text-[#0d2b5b] md:max-w-none md:text-[52px] md:leading-[1.14]">
              Plan de Legado Familiar IUL 2026
            </h1>
            <p className="mx-auto mt-4 max-w-[340px] border-b-2 border-[#f1f5f9] pb-[15px] text-[13px] leading-[1.2] text-[#64748b] md:max-w-none md:text-[18px]">
              Exclusivo para asegurar el futuro de tu familia
            </p>
          </div>
          ...
          <div className="mt-[15px] grid gap-[12px]">
            {introBenefits.map((benefit) => (
              ...
              >
                ...
                <div className="flex flex-1 items-center gap-[12px] px-[18px] py-[14px]">
                  ...
                  <div className="min-w-0 text-left">
                    ...
                    <p className="mt-1 text-[15px] leading-[1.32] text-[#475569] md:text-[16px]">
                      {benefit.description}
                    </p>
                  </div>
                </div>
